...
public extension UITabBarItem {
    ...
    public func setFAIcon(icon: FAType, customSize: CGSize) {
        image = UIImage(icon: icon, size: customSize ?? CGSizeMake(30, 30))
    }
}
        ...
        if (UIFont.fontNamesForFamilyName(FAStruct.FontName).count == 0) {
            ...
            dispatch_once(&Static.onceToken) {
                ...
                if identifier?.hasPrefix("org.cocoapods") == true {
                    ...
                    fontURL = bundle.URLForResource(FAStruct.FontName, withExtension: "ttf", subdirectory: "resource")!
                }
